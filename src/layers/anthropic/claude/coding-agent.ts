...
export const CLAUDE_CODING_AGENT_LAYER: PromptLayer = {
  ...
  content: joinSections(
    ...
    section("context_before_edit", [
      ...
      "For files being modified, inspect the surrounding function, type, module boundary, and any key call sites or dependent contracts as needed.",
    ...
    section("implementation_reporting", [
      ...
      "Run the fastest relevant verification step when feasible.",
      "If verification was not run or could not be completed, say so explicitly.",
    ]),
    section("tool_usage_discipline", [
      "Use dedicated tools over general shell commands when available (e.g., Read over cat, Edit over sed).",
      "Parallelize independent operations when safe to do so.",
  ...
  meta: {
    ...
    fixes: [
      ...
      "underuse of dedicated tools in favor of general shell commands",
    ],
    nonGoals: [
